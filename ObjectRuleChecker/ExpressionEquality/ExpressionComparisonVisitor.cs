    ...
    internal class ExpressionComparisonVisitor
    {
        ...
        private bool Visit(Expression a, Expression b)
        {
            ...
            switch (a.NodeType)
            {
                ...
                default:
                    throw new ArgumentException($"Unhandled expression type: '{a.NodeType}'");
            }
        }
        ...
        protected virtual bool VisitBinding(MemberBinding a, MemberBinding b)
        {
            ...
            switch (a.BindingType)
            {
                ...
                default:
                    throw new ArgumentException($"Unhandled binding type '{a.BindingType}'");
            }
        }
        ...
        private static bool CheckEqual<T>(T t, T candidate, CheckEqualsMethod method = CheckEqualsMethod.ObjectEquals, bool checkNull = false)
        {
            if (checkNull)
            {
